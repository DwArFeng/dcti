package com.dwarfeng.dcti.api.integration.example;
...
public class TelqosExample {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("这是一个示例, 用于演示 dcti 的 Telqos 功能");
        System.out.println("您可以使用 telnet 客户端工具访问本机 ${telqos.port} 端口以体验本示例的功能");
        System.out.println("您可以使用 telqos 的 dcti 命令以操作 dcti qos 服务");
