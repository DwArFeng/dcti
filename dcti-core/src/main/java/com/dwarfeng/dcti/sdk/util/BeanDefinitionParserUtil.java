...
public final class BeanDefinitionParserUtil {
     ...
     *
     * <p>
     * 需要注意的是，由于 SpEL 解析后的结果可能是一个对象，因此该方法的返回值类型为 <code>Object</code>。
     ...
     * 如无法使用 Spring 的 BeanFactory 提供的 <code>org.springframework.expression.ParserContext</code>。<br>
     * 因此，在任何可能的情况下，建议先使用 <code>mayResolvePlaceholder</code> 方法解析占位符。
     * 比如：
     * <blockquote><pre>
